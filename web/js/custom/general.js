...
jQuery(document).ready(function(){
        ...
        //    return ""
        //}
	/////// COLLAPSED/EXPAND LEFT MENU BY STATUS 根据状态收缩菜单栏 /////
        //        navStatus = getCookie('toggle_nav_status');
	...
	//		}
	//		
	//		jQuery('a.togglemenu').addClass('togglemenu_collapsed');
	//		
	//		//jQuery('.iconmenu > ul > li > a').each(function(){
	//		//	var label = jQuery('a.togglemenu').text();
	//		//	jQuery('<li><span>'+label+'</span></li>')
	//		//		.insertBefore(jQuery('a.togglemenu').parent().find('ul li:first-child'));
	//		//});
	...
	//		}
	//		jQuery('a.togglemenu').removeClass('togglemenu_collapsed');	
	//		
