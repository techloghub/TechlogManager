...
class Twig_Extension_Core extends Twig_Extension
{
    ...
    public function getFilters()
    {
        $filters = array(
            ...
            'key_exists' => new Twig_Filter_Function('twig_key_exists_filter'),
            ...
            'substr'     => new Twig_Filter_Function('mb_substr'),
 ...
 *
 * @param string   $json   The value to decode.
 *
 * @return mixed The JSON decoded value
 */
function twig_jsondecode_filter($json)
{
    return json_decode($json, true);
}

function twig_key_exists_filter($arr, $k)
{
    if (empty($arr)) {
        return false;
    }
